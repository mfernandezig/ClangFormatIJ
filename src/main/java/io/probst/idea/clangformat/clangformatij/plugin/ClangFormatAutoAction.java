//#***************************************************************************
//# freenet Technologie und Prozesse Source File: ClangFormatAutoAction.java
...
/********************************************************************
 * Runs clang-format on the current selection or on the whole file if there is no selection. Applies the
 * formatting updates to the editor.
 */
